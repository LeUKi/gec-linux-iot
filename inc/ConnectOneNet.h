...
#define DEVICE_ID "1018875618"                  //用户根据自己的实际情况决定
#define AUTH_KEY "TYuZmLp84GyZ=rJV18bL2MMnhWg=" //用户根据自己的实际情况决定
...
//	说明：		
//==========================================================
void OneNet_SendData(char *buf,char *stream,char wdata);
